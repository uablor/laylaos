...
export class UpdateSchema1763097687787 implements MigrationInterface {
    name = 'UpdateSchema1763097687787'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`hotels\` DROP FOREIGN KEY \`FK_b8c294c943562108625f57916d9\``);
        ...
        await queryRunner.query(`ALTER TABLE \`hotels\` CHANGE \`start_time\` \`start_time\` time NULL`);
        await queryRunner.query(`ALTER TABLE \`hotels\` CHANGE \`end_time\` \`end_time\` time NULL`);
        await queryRunner.query(`ALTER TABLE \`hotels\` CHANGE \`email_hotel\` \`email_hotel\` varchar(100) NULL`);
        await queryRunner.query(`ALTER TABLE \`hotels\` CHANGE \`logoId\` \`logoId\` int NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`hotels\` ADD CONSTRAINT \`FK_b8c294c943562108625f57916d9\` FOREIGN KEY (\`logoId\`) REFERENCES \`image_orm_entity\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`hotels\` CHANGE \`logoId\` \`logoId\` int NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`hotels\` CHANGE \`email_hotel\` \`email_hotel\` varchar(100) NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`hotels\` CHANGE \`end_time\` \`end_time\` time NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`hotels\` CHANGE \`start_time\` \`start_time\` time NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`hotels\` ADD CONSTRAINT \`FK_656dce2a8012700e598a45cfd3f\` FOREIGN KEY (\`zone_id\`) REFERENCES \`zones\`(\`id\`) ON DELETE SET NULL ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE \`image_orm_entity\` ADD CONSTRAINT \`FK_7d84aaeedd6b9fa4cac3e966ed1\` FOREIGN KEY (\`roomTypeId\`) REFERENCES \`room_types\`(\`id\`) ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`image_orm_entity\` ADD CONSTRAINT \`FK_5ae386c2ea0cff6d7bb11c609f3\` FOREIGN KEY (\`hotelId\`) REFERENCES \`hotels\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`hotels\` ADD CONSTRAINT \`FK_b8c294c943562108625f57916d9\` FOREIGN KEY (\`logoId\`) REFERENCES \`image_orm_entity\`(\`id\`) ON DELETE CASCADE ON UPDATE NO ACTION`);
    }
