...
export class UpdateSchema1762235626678 implements MigrationInterface {
    name = 'UpdateSchema1762235626678'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`DROP INDEX \`FK_7d84aaeedd6b9fa4cac3e966ed1\` ON \`image_orm_entity\``);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE INDEX \`FK_7d84aaeedd6b9fa4cac3e966ed1\` ON \`image_orm_entity\` (\`roomTypeId\`)`);
    }
